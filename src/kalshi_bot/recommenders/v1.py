"""
TemperatureRecommenderV1 — FROZEN 2026-05-26. Do not modify.

Uses live NWS + NBM API calls to compute edge on Kalshi temperature bracket
markets. This is the locked-in baseline. For historical replay use
recommenders.v1_historical.TemperatureRecommenderV1Historical.
...
class TemperatureRecommenderV1:
    """
